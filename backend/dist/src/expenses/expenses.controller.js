...
let ExpensesController = class ExpensesController {
    ...
    findAll(page, limit, startDate, endDate) {
        return this.expensesService.findAll(page ? +page : 1, limit ? +limit : 10, startDate, endDate);
    }
    create(data, req) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_expense_dto_1.CreateExpenseCategoryDto]),
    __metadata("design:returntype", void 0)
